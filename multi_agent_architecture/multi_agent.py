...
# python_repl_tools.invoke("x = 5; print(x)")

class Supervisor(BaseModel):
    next: Literal["enhancer","researcher","coder"] = Field(
        description="Determines which specialist to activate next in the workflow sequence:"
                        "'enhancer' when user input requires clarification, expansion and refinement"
                        " 'researcher' when additional facts, context or data collection is necessary"
                        " 'coder' when implementation, computation or technical-problem solving is required."
    )
    reason: str = Field(
        description="Detailed justification for routing decision, explaining the rationale behind selecting the particular specialist and how this advances the work toward completition."
    )
...
inputs = {
    "messages": [
        ("user", "Can you write me a linkedIn post of how I can make a multi agent"),
    ]
}
